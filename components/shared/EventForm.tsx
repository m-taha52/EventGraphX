                  ...
                  <FormItem className="w-full">
                    <FormControl>
                      <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-gray-50 px-4 py-2">
                        ...
                        <Image 
                        src="/assets/icons/dollar.svg" alt="price" width={24} height={24} className="filter-grey"
                        />
                        ...
                        (
                          <FormItem>
                            <FormControl>
                              ...
                              <Checkbox id="isFree" className="mr-2 h-5 w-5 border-2 border-primary-500" onCheckedChange={field.onChange}
                              checked={field.value} />
                              </div>
                            </FormControl>
                            <FormMessage />
